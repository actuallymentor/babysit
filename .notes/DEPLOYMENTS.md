...
- 2026-09-24: Published [v1.5.0](https://github.com/actuallymentor/babysit/releases/tag/v1.5.0) from `4f3ef0f` via [release run 36017931596](https://github.com/actuallymentor/babysit/actions/runs/36017931596). Four binaries and checksums published; downloaded Linux x64 binary verified and smoke-tested. Agent `1.5.0` manifest: `sha256:66167858cfbd4cdabff5d97a36e4e1e2507154ce1edd243448710f5ed990ee6d`. Web `1.5.0`/`latest` manifest: `sha256:7d8936c784f23259c9287c49e72151c74c3c8f204526fd59dd3e3e9fb4fb88e3`. Both images contain amd64/arm64; agent `latest` remains on the separate nightly workflow.
